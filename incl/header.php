    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        if (isset($_SESSION['nom'])) {
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="profile.php">Mon profile  <i class="bi bi-person"></i></a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="deconnexion.php">Déconnexion  <i class="bi bi-box-arrow-right"></i></a></li>
          </ul>
        </div> ';

          if (isset($_SESSION['panier'][3]) && is_array($_SESSION['panier'][3])) {
            print ' <li class="nav-item">
              <a class=" btnPanier nav-link" aria-current="page" href="panier.php"> <i class="bi bi-cart3"></i> <span class="text-danger">( ' . count($_SESSION['panier'][3]) . ' )</span> </a>
            </li> ';
          } else {
            print ' <li class="nav-item">
